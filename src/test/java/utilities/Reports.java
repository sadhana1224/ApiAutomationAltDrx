...
public static void startReport()
{
	try
	{
		sparkReporter= new ExtentSparkReporter(System.getProperty("user.dir")+"/AltDrxApi.html");
		sparkReporter.config().setDocumentTitle("AltDrx Report");
		sparkReporter.config().setReportName("AltDrx API Automation");
